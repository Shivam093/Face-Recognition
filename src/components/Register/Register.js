...
class Register extends React.Component {
	...
	onSubmitRegister=() =>{
		fetch('https://fierce-bayou-75438.herokuapp.com/register', {
			method: 'post',
			  ...
			  <div className="measure">
			    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
			      ...
			      <div className="mt3">
			        ...
			        <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="email" name="name" onChange={this.onNameChange} id="name"/>
			      </div>
			      <div className="mt3">
